...
const displayContent = (text) => {
	return text.length < 30
		? // the text will show if word limit is less then 30 instead of text
		  text
...
const switchTab = (id) => {
	if (id === "posts") {
		...
		document.getElementById("reported").style.display.textContent = 0;
	} else if (id === "liked") {
